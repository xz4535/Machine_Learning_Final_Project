...
stock_data = tesla_data.history(period=period, interval=interval)

# Filter and save the data for 2023 and 2024
for year in [2023, 2024]:
    stock_data_year = stock_data[stock_data.index.year == year]
    stock_data_year.to_csv(f'ADS.DE_stock_data_day_{year}.csv', index=True)
...
#     stock_data_daily = stock_data.history(period=period, interval=interval)
    
#     # Filter and save the data for 2023 and 2024
#     for year in [2023, 2024]:
#         stock_data_year = stock_data_daily[stock_data_daily.index.year == year]
